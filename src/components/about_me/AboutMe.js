    ...
    return (
        <div class="mt-32 flex gap-6 max-w-5xl mx-auto text-white px-2 flex-wrap md:flex-nowrap">
            <div data-theme="mytheme" class="mx-auto">
                <div>
                    <img src={hero1} alt='Abdelrahman Sabry with a hat in a park on a Friday day.' class='max-w-xs' />
                </div>
                ...
                <div class="w-4/5 mx-auto mt-14 flex justify-around">
                    <IconWhite icon={iconLinkedIn} goTo='https://www.linkedin.com/in/abdelrahman-sabry-saber-4194b21a5/' ariaLabel='LinkedIn'>LinkedIn</IconWhite>
                    <IconWhite icon={iconGitHub} goTo='https://github.com/A-132001/' ariaLabel='GitHub'>GitHub</IconWhite>
                </div>
            </div>
            <div class="">
                <H3Header>
